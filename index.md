...
# Things to keep in mind<a name="Note"></a>
  - A scenario that happens often is that the subject has failed the condition before all the images are shown. 
	  ...
	  - If you can not determine the main identity of the subject from the first 10~20 pictures, then this scenario might occur as well. So you can skim some more pictures until it is obvious that the subject h
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM4NjkyMzI3OSwtMTQzMzYxNjAzNF19
-->