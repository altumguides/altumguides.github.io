...
# Things to keep in mind<a name="Note"></a>
  ...
  - You don't have to always mark pictures if it is easier to count and approximate the `Percentage` yourself. If you do this, make sure you know that the 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjUzODUxMzk2LC0xNDMzNjE2MDM0XX0=
-->