...
# Things to keep in mind<a name="Note"></a>
  ...
  - You don't have to always mark pictures if it is easier to count and approximate the `Percentage` yourself. If you do this, make sure you are certain that the subject is a pass or fail. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM2NTc0MDc0NiwtMTQzMzYxNjAzNF19
-->