...
# Things to keep in mind<a name="Note"></a>
  ...
  - A scenario that happens often is that the subject has failed the condition before all the images are shown. Looking through each image carefully allows you to save time 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MDU1NzgzNjAsLTE0MzM2MTYwMzRdfQ
==
-->