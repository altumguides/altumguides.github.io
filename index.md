...
The UI consists of several parts that each have their own uses. I will break them down below and explain what each part is for.
  1. The top left section of the page indicates whether or not a subject has been annotated. Nothing will be here when the current subject has no. When you submit, a dialogue box will appear in this section to show you what you have submitted.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg0NDM5MDAzNCwtMTQzMzYxNjAzNF19
-->